...
class Console(cmd.Cmd):
    ...
    main BitGod Framework console interface.
    """
 ...
 _   _    _    ____ _  ______  ___  ____  
| | | |  / \  / ___| |/ / ___|/ _ \|  _ \ 
| |_| | / _ \| |   | ' / |  _| | | | | | |
|  _  |/ ___ \ |___| . \ |_| | |_| | |_| |
|_| |_/_/   \_\____|_|\_\____|\___/|____/ 
--=[ %bold%whiteGhost Framework 6.0.0%end
--=[ Developed by BitWalls_Sec (%linehttps://entysec.com/%end)
"""
